...
class TaskGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Task entity")
        ...
        .repeat(2) {
            ...
            .put("/api/tasks")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "priority":"0", "EndDate":"2020-01-01T00:00:00.000Z", "topic":"SAMPLE_TEXT", "type":"SAMPLE_TEXT", "completed":null, "insertDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
